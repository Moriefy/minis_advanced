...
import com.minis.haprial.offload.ShizukuManager
...
fun OffloadPermissionScreen(
    ...
    val configEnabled by com.minis.haprial.config.MinisConfigPermissionStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = {
                    com.minis.haprial.config.MinisConfigPermissionStore.setEnabled(it)
                },
                showDivider = false,
            )
        }
        ...
        AlertDialog(
            ...
            confirmButton = {
                MinisTextButton(onClick = {
                    ...
                    com.minis.haprial.config.MinisConfigPermissionStore.setEnabled(true)

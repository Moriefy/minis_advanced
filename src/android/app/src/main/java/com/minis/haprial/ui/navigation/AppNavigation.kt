package com.minis.haprial.ui.navigation
...
import com.minis.haprial.deeplink.DeepLinkAction
import com.minis.haprial.deeplink.DeepLinkCoordinator
import com.minis.haprial.ui.settings.KEY_LAUNCH_SESSION
import com.minis.haprial.ui.settings.getAppearancePrefs
...
import com.minis.haprial.ui.settings.BackgroundSettingsScreen
import com.minis.haprial.ui.settings.AddModelsToGroupScreen
import com.minis.haprial.ui.settings.ShadowVoiceDetailScreen
import com.minis.haprial.ui.settings.AddProviderScreen
import com.minis.haprial.ui.settings.ModelEntryDetailScreen
import com.minis.haprial.ui.settings.ModelGroupDetailScreen
import com.minis.haprial.ui.settings.ModelGroupsScreen
import com.minis.haprial.ui.settings.ProviderDetailScreen
import com.minis.haprial.ui.settings.ProviderListScreen
import com.minis.haprial.ui.sandbox.FileBrowserScreen
import com.minis.haprial.ui.sandbox.FileBrowserViewModel
import com.minis.haprial.ui.sandbox.FileItem
import com.minis.haprial.ui.sandbox.FilePreviewScreen
import com.minis.haprial.ui.sandbox.RootfsManagementScreen
import com.minis.haprial.ui.settings.EnvironmentVariablesScreen
import com.minis.haprial.ui.settings.AppearanceScreen
import com.minis.haprial.ui.settings.SettingsScreen
import com.minis.haprial.ui.settings.SystemPermissionsScreen
import com.minis.haprial.ui.settings.SessionStorageDetailScreen
import com.minis.haprial.ui.settings.SkillDetailScreen
import com.minis.haprial.ui.settings.StorageManagementScreen
import com.minis.haprial.ui.settings.SkillFileViewerScreen
import com.minis.haprial.ui.settings.UsageStatsScreen
import com.minis.haprial.ui.settings.MinisSkillsBrowserScreen
import com.minis.haprial.ui.settings.MountDetailScreen
import com.minis.haprial.ui.settings.MountedFoldersScreen
import com.minis.haprial.ui.settings.SharedFolderDetailScreen
import com.minis.haprial.ui.settings.SharedFoldersScreen
import com.minis.haprial.ui.settings.SkillsManagementScreen
...
import com.minis.haprial.ui.settings.LogDetailScreen
import com.minis.haprial.ui.settings.LogManagementScreen
import com.minis.haprial.ui.settings.MemoryFileEditScreen
import com.minis.haprial.ui.settings.MemoryManagementScreen
import com.minis.haprial.ui.settings.OffloadPermissionScreen
import com.minis.haprial.ui.settings.ShizukuPermissionScreen
import com.minis.haprial.sandbox.RootfsManager
import com.minis.haprial.sandbox.TerminalSession
import com.minis.haprial.ui.terminal.TerminalScreen
import com.minis.haprial.ui.onboarding.OnboardingModelSelectionScreen
...
fun AppNavigation(
    ...
    val mountedFoldersStore = remember {
        (context.applicationContext as com.minis.haprial.MinisApp).mountedFoldersStore
    }
    ...
    LaunchedEffect(Unit) {
        ...
        val hasPendingShare =
            com.minis.haprial.share.ShareCoordinator.bufferVersion.value > 0
        ...
        val mode = if (
            com.minis.haprial.diagnostics.HangDetector.shouldForceHomeOnLaunch(context) ||
            com.minis.haprial.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(context) ||
            com.minis.haprial.diagnostics.LaunchCycleBeacon.shouldForceHomeOnLaunch()
        ) 3 else rawMode
    ...
    NavHost(
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val label = when (folderId) {
                        "shared" -> ctx.getString(com.minis.haprial.R.string.shared_folder_name_shared)
                        "skills" -> ctx.getString(com.minis.haprial.R.string.shared_folder_name_skills)
                        "memory" -> ctx.getString(com.minis.haprial.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(
            ...
            val category = com.minis.haprial.ui.sandbox.MirrorCatalog.categoryFromKey(categoryKey)
                ?: return@composable
            com.minis.haprial.ui.sandbox.MirrorCategoryDetailScreen(
                category = category,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                com.minis.haprial.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            com.minis.haprial.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            com.minis.haprial.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            com.minis.haprial.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            com.minis.haprial.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))

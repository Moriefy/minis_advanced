...
import com.minis.haprial.ui.components.PickerModalityFilter
import com.minis.haprial.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<com.minis.haprial.data.model.ModelEntry?>(null) }

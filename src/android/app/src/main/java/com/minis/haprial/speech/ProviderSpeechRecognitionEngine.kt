package com.minis.haprial.speech
...
import com.minis.haprial.provider.voice.VoiceInputRequest
import com.minis.haprial.provider.voice.VoiceProvider
import com.minis.haprial.provider.voice.VoiceProviderException
import com.minis.haprial.provider.voice.VoiceProviderFactory
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: com.minis.haprial.data.repository.ProviderRepository,
        candidates: List<Pair<com.minis.haprial.data.model.ProviderInstance, com.minis.haprial.data.model.ModelEntry>>,

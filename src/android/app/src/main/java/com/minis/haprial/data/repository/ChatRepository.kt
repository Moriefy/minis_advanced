...
import com.minis.haprial.data.db.ChatDao
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.minis.haprial.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.minis.haprial.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.minis.haprial.share.ChatExporter]

...
import com.minis.haprial.data.db.AppDatabase
import com.minis.haprial.data.repository.BackgroundSettingsRepository
import com.minis.haprial.data.repository.ChatRepository
import com.minis.haprial.data.repository.EnvVarRepository
import com.minis.haprial.data.MountedFoldersStore
import com.minis.haprial.data.repository.MemoryRepository
import com.minis.haprial.data.repository.ProviderRepository
import com.minis.haprial.data.repository.WebAppShortcutRepository
import com.minis.haprial.data.repository.MCPRepository
import com.minis.haprial.data.repository.SkillRepository
import com.minis.haprial.notification.BackgroundTaskNotifier
import com.minis.haprial.logging.AppLogger
import com.minis.haprial.network.NetworkMonitor
import com.minis.haprial.offload.OffloadPermissionManager
import com.minis.haprial.provider.ModelsDevApi
import com.minis.haprial.sandbox.ExecutionCoordinator
import com.minis.haprial.sandbox.MountedFolderCoordinator
import com.minis.haprial.sandbox.NativeOffloadServer
import com.minis.haprial.sandbox.PRootKernel
import com.minis.haprial.sandbox.RootfsManager
import com.minis.haprial.sandbox.offload.AccessibilityOffloadHandler
import com.minis.haprial.sandbox.offload.AlarmOffloadHandler
import com.minis.haprial.sandbox.offload.BrowserUseOffloadHandler
import com.minis.haprial.sandbox.offload.CalendarOffloadHandler
import com.minis.haprial.sandbox.offload.ClipboardOffloadHandler
import com.minis.haprial.sandbox.offload.ContactsOffloadHandler
import com.minis.haprial.sandbox.offload.DeviceOffloadHandler
import com.minis.haprial.sandbox.offload.LocationOffloadHandler
import com.minis.haprial.sandbox.offload.ModelUseOffloadHandler
import com.minis.haprial.sandbox.offload.SessionsOffloadHandler
import com.minis.haprial.sandbox.offload.ShizukuOffloadHandler
import com.minis.haprial.sandbox.offload.NotificationOffloadHandler
import com.minis.haprial.sandbox.offload.OpenOffloadHandler
import com.minis.haprial.sandbox.offload.PhotosOffloadHandler
import com.minis.haprial.sandbox.offload.PlayerOffloadHandler
import com.minis.haprial.sandbox.offload.SpeakOffloadHandler
import com.minis.haprial.sandbox.offload.SpeechOffloadHandler
import com.minis.haprial.sandbox.offload.WeatherOffloadHandler
import com.minis.haprial.service.SessionActivityTracker
import com.minis.haprial.ui.MinisImageFetcher
...
class MinisApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        com.minis.haprial.data.FastModePrefs.prime(this)
        ...
        // Activity context.
        com.minis.haprial.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.minis.haprial.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.minis.haprial.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.minis.haprial.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.minis.haprial.diagnostics.LaunchCycleBeacon].
        try {
            com.minis.haprial.diagnostics.LaunchCycleBeacon.recordLaunch(this)
        } catch (t: Throwable) {
        ...
        com.minis.haprial.diagnostics.HangDetector.start(this)
        ...
        com.minis.haprial.agent.SoulStore.ensureExists(this)
        com.minis.haprial.agent.SoulStore.refreshCache(this)
        ...
        com.minis.haprial.config.MinisConfigPermissionStore.init(this)
        com.minis.haprial.config.audit.ConfigAuditLog.init(this)
        com.minis.haprial.config.ConfigRegistry.init(
        ...
        com.minis.haprial.data.EnvVarPrivacyStore.init(this)
        com.minis.haprial.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        NativeOffloadServer.register(
            "minis-config",
            com.minis.haprial.sandbox.offload.ConfigOffloadHandler(),
        )
        ...
        NativeOffloadServer.register(
            "minis-scheduled",
            com.minis.haprial.sandbox.offload.ScheduledTaskOffloadHandler(this),
        )
        ...
        com.minis.haprial.offload.ShizukuManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            NativeOffloadServer.register(
                "minis-debug",
                com.minis.haprial.sandbox.offload.DebugOffloadHandler(this),
            )
        }
        ...
        com.minis.haprial.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.minis.haprial.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        val configConfirmNotifier = com.minis.haprial.notification.ConfigConfirmNotifier(
            context = this,
            backgroundSettings = backgroundSettingsRepository,
            isAppForeground = ::isAppForeground,
        )
        com.minis.haprial.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.minis.haprial.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.minis.haprial.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.minis.haprial.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
        ...
        com.minis.haprial.speech.SpeechRecognitionManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            try {
                com.minis.haprial.debug.DebugServer(this).start()
            } catch (e: Exception) {
    ...
    override fun onTrimMemory(level: Int) {
        ...
        runCatching { com.minis.haprial.ui.chat.KatexWebViewPool.evictAll() }
            .onFailure { Log.w("MinisApp", "KatexWebViewPool.evictAll failed: ${it.message}") }
        runCatching { com.minis.haprial.ui.markdown.KaTeXRendererCache.evictAll() }
        ...
        if (level >= TRIM_MEMORY_COMPLETE) {
            ...
            runCatching { com.minis.haprial.ui.chat.KatexWebViewPool.releaseWebView() }
    ...
    override fun onTerminate() {
        ...
        try {
            com.minis.haprial.diagnostics.LaunchCycleBeacon.recordCleanExit(this)
        } catch (t: Throwable) {

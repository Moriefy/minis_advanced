package com.minis.haprial.scheduled
...
import com.minis.haprial.debug.HeadlessChatRunner
import com.minis.haprial.logging.AppLogger
import com.minis.haprial.service.AgentForegroundService
    ...
    private suspend fun resolveSessionId(app: MinisApp, task: ScheduledTask): String? {
        return when (val mode = task.targetMode) {
            ...
            ScheduledTargetMode.NewSession -> {
                ...
                val memoryOn = com.minis.haprial.data.MemoryGlobalPrefs.isGlobalEnabled(app)

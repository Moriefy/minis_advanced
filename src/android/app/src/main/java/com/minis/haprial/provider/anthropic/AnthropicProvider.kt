...
class AnthropicProvider(
    ...
    internal fun resolveSystemPrompt(userPrompt: String?): JSONArray? {
        val claudeCodePrefix = com.minis.haprial.auth.ClaudeOAuthManager.ANTHROPIC_OAUTH_IDENTIFIER_PROMPT
        if (isOAuth) {
    ...
    private fun buildRequest(bodyStr: String, body: JSONObject): Request {
        ...
        builder.applyUserAgentOverride(
            customUserAgent,
            defaultUserAgent = if (isOAuth) null else com.minis.haprial.provider.MinisUserAgent.DEFAULT,
        )

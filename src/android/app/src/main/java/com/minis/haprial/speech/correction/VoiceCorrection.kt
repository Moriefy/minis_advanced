package com.minis.haprial.speech.correction

import android.content.Context
import android.util.Log
import com.minis.haprial.MinisApp
import com.minis.haprial.shared.TextSegmenter
...
object VoiceCorrection {
    ...
    fun ensureInitialized(context: Context) {
        ...
        val dao = runCatching {
            com.minis.haprial.data.db.AppDatabase.getInstance(app).chatDao()
        }.getOrNull()
        if (dao != null) {
    ...
    fun buildConversationContext(
        context: Context,
        messages: List<com.minis.haprial.ui.chat.ChatMessage>,
    ): ConversationContext {
        ensureInitialized(context)

package com.minis.haprial.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.minis.haprial.service.SessionActivityTracker]
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.minis.haprial.service.SessionActivityTracker] when a

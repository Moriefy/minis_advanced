...
import com.minis.haprial.scheduled.ScheduledRepeatMode
import com.minis.haprial.scheduled.ScheduledTargetMode
import com.minis.haprial.scheduled.ScheduledTask
import com.minis.haprial.scheduled.ScheduledTaskManager
...
class ScheduledTaskOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun handleRun(args: OffloadArgs): NativeOffloadResult {
        ...
        val sessionId = runBlocking {
            com.minis.haprial.scheduled.ScheduledAgentRunner.run(context, task)
        }
        val out = JSONObject()
            .put("id", id)

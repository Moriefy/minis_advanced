...
fun FileBrowserScreen(
    ...
    var webAppSheetSource by remember { mutableStateOf<com.minis.haprial.webapp.WebAppSource.HostFile?>(null) }
...
private fun FileItemRow(
    ...
    onClick: () -> Unit,
    onDelete: () -> Unit,
    onAddToHome: (com.minis.haprial.webapp.WebAppSource.HostFile) -> Unit,
) {
    ...
    run {
        ...
        com.minis.haprial.ui.components.MinisMenu(
            ...
            DropdownMenuItem(
                ...
                onClick = {
                    menuExpanded = false
                    val triple = com.minis.haprial.webapp.WebAppPathResolver.inferScope(item.file)
                    if (triple != null) {
                        val (scope, ctx, linuxPath) = triple
                        onAddToHome(
                            com.minis.haprial.webapp.WebAppSource.HostFile(
                                file = item.file,
                                fileName = item.name,
                                pathScope = scope,
                                scopeContext = ctx,
...
private fun MoreMenu(
    ...
    Box {
        ...
        com.minis.haprial.ui.components.MinisMenu(expanded = expanded, onDismissRequest = { expanded = false }) {

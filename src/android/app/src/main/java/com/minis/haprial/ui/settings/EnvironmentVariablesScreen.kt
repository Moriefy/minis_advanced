...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by com.minis.haprial.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { com.minis.haprial.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }

...
import com.minis.haprial.accessibility.AccessibilityRecoveryManager
...
import com.minis.haprial.deeplink.DeepLinkHandler
import com.minis.haprial.logging.AppLogger
import com.minis.haprial.service.SessionActivityTracker
import com.minis.haprial.ui.navigation.AppNavigation
import com.minis.haprial.ui.navigation.Routes
import com.minis.haprial.ui.navigation.safeNavigate
import com.minis.haprial.ui.settings.KEY_FONT_APP_BASE
import com.minis.haprial.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.minis.haprial.ui.settings.KEY_LANGUAGE
import com.minis.haprial.ui.settings.KEY_LAUNCH_SESSION
import com.minis.haprial.ui.settings.KEY_THEME_MODE
import com.minis.haprial.ui.settings.PREF_APPEARANCE
import com.minis.haprial.ui.settings.getAppearancePrefs
import com.minis.haprial.ui.settings.fontScaleForLevel
import com.minis.haprial.ui.settings.keepScreenAwakeEnabled
import com.minis.haprial.ui.theme.MinisTheme
...
class MainActivity : ComponentActivity() {
     ...
     * [com.minis.haprial.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.minis.haprial.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (minisApp == null || !minisApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${com.minis.haprial.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            com.minis.haprial.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.minis.haprial.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        com.minis.haprial.share.ShareCoordinator.processPendingShare(this)
        ...
        if (BuildConfig.DEBUG) {
            com.minis.haprial.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            MinisTheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                com.minis.haprial.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.minis.haprial.ui.navigation.AppNavigation]

package com.minis.haprial.auth
...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun forInstance(context: Context, instance: com.minis.haprial.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.minis.haprial.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.minis.haprial.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.minis.haprial.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.minis.haprial.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.minis.haprial.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")

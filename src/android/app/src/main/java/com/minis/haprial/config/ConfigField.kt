...
/**
 * One configurable setting. Concrete kinds: [com.minis.haprial.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.minis.haprial.config.fields.ClosureField]

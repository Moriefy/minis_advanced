 ...
 * in [com.minis.haprial.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    ...
    /** Serialized [com.minis.haprial.provider.thinking.ThinkingWireFormat]; null = "no opinion". */

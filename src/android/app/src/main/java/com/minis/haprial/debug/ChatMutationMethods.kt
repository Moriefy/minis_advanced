...
import com.minis.haprial.ui.chat.InputAttachment
...
internal object ChatMutationMethods {
     ...
     * [com.minis.haprial.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.minis.haprial.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.minis.haprial.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.minis.haprial.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.minis.haprial.service.SessionActivityTracker.isActive(sessionId))
